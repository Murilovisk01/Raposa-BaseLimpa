...
class executarComando:
    def executarComando(self, destino, senha, comando):
        try:
            ...
            print(f"\033[94m→ Executando: {comando}\033[0m")

            resultado = subprocess.run(comando_ssh, shell=True, text=True)

            if resultado.returncode == 0:
                print("\033[92m✔ Comando executado com sucesso.\033[0m")
            else:
                print(f"\033[91m✖ Comando retornou erro. Código: {resultado.returncode}\033[0m")

        except Exception as e:
            print(f"\033[91m✖ Erro ao executar o comando: {e}\033[0m")
